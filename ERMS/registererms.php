...
<head>
  ...
  <title>Volunteer Record Management System</title>
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 1%">Volunteer Record Management System</h3>
              ...
              <form class="user" name="register" method="post" onsubmit="return checkpass();">
                <div class="form-group row">
                 ...
                 <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="empcode" name="empcode" placeholder="Enter your Volunteer Code" pattern="[0-9]+" required="true">
                </div>
                <div class="form-group">
