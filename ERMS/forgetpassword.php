...
<head>
  ...
  <meta name="viewport" content="Volunteer Record management System in php and mysql">
  <meta name="description" content="Volunteer Record management System in php and mysql">
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 2%">Volunteer Record Managment System</h3>
    ...
    echo $msg;
                  ...
                  <form class="user" method="post" action="">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="empid" name="empid" placeholder="Enter your volunteer Code" required="true">
                    </div>
